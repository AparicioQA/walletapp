    ...
    return (
        <>
            ...
            <div className='bg-indigo-800 rounded p-4 w-11/12 max-w-sm mt-4'>
                <p className='text-white'>Saldo en efectivo: <span className='text-lime-300'>{efectivo}</span></p>
                <p className='text-white'>Saldo en targeta: <span className='text-lime-300'>{targeta}</span></p>
            </div>
        </>
